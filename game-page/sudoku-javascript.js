...
function openModal(time, score, completestatus) {
    ...
    saveScore({ time: formattedTime, result: score, status: completestatus}, "NormalSudoku" );
}
...
function displayScoreboardModal() {
    ...
    scores.forEach((score, index) => {
        ...
        cellGameType.innerHTML = 'Normal Sudoku'; // Replace this with the actual game type
